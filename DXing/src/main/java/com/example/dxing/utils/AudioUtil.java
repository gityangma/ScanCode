...
public class AudioUtil implements MediaPlayer.OnCompletionListener,
    ...
    public synchronized void playSound() {
        try {
            ...
            Log.e(ConfigType.TAG, "playSound error : " + e.getMessage());
        }
    }
    ...
    private MediaPlayer buildMediaPlayer(Context activity) {
        ...
        try {
            ...
            mediaPlayer.release();
            Log.e(ConfigType.TAG, "buildMediaPlayer error : " + ioe.getMessage());
            return null;
        }
    }
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        try {
            ...
            Log.e(ConfigType.TAG, "seek error : " + e.getMessage());
        }
    }
